...
A corto plazo, la tarea prioritaria es **configurar el esquema de Supabase descrito**
en la sección de [Diseño de base de datos (Supabase)](#diseño-de-base-de-datos-supabase),
como parte de la **Fase 1 – Fundaciones técnicas**. Esto asegura una base sólida
para el resto de funcionalidades del constructor de formularios y la app móvil.
